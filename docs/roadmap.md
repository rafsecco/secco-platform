...
**Fase 8 concluída** — o NotificationHub cobre envio de e-mail assíncrono com retry, status consultável e os dois providers de banco. A plataforma ganhou `IBackgroundJobScheduler` como capacidade reutilizável (ADR-0015 Camada 2) para qualquer produto futuro que precise de jobs persistentes. Configuration, FeatureFlags e Audit seguem no backlog.
