    ...
    public partial class TenantFederations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_pk_tenant_federation = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    id_fk_tenant = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ds_provider = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    directory_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
