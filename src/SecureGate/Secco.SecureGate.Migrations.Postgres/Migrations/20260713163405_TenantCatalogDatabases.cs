    ...
    public partial class TenantCatalogDatabases : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_pk_tenant_database = table.Column<Guid>(type: "uuid", nullable: false),
                    id_fk_tenant = table.Column<Guid>(type: "uuid", nullable: false),
                    ds_product = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ds_connection_string = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
