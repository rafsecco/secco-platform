...
/// <summary>Busca paginada de registros de log do banco do tenant atual.</summary>
public sealed class SearchLogEntriesHandler(ILogEntryRepository repository)
{
    /// <summary>Executa o caso de uso.</summary>
    /// <param name="criteria">Filtros e paginação.</param>
    /// <param name="cancellationToken">Token de cancelamento.</param>
    public async Task<Result<PagedResult<LogEntryDto>>> HandleAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return PagedResult.Create(
            page.Items.Select(LogEntryDto.FromEntity).ToList(),
