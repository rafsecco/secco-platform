...
public class SampleEndpointsTests(NotificationHubApiFactory factory) : IClassFixture<NotificationHubApiFactory>, IAsyncLifetime
{
    ...
    public async Task PostSample_WithoutName_Returns400ProblemDetails()
    {
        ...
        (await response.Content.ReadAsStringAsync()).Should().Contain("NotificationHub.Sample.NameRequired");
    }
